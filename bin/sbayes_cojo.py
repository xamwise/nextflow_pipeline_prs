...
def get_parser():
    parser = argparse.ArgumentParser(description="Preprocess GWAS data for SBAYESR.")
...
def main():
    ...
    required_cols = ['SNP', 'A1', 'A2', 'MAF', effect_col, 'SE', 'P', 'N']
    ...
    # Rename columns for SBAYESR in COJO format
    df_filtered.rename(columns={effect_col: 'b', 'MAF': 'freq', 'SE': 'se', 'P': 'p'}, inplace=True)
